...
public sealed record PostPoll
{
    ...
    private PostPoll(IReadOnlyList<string> answers, TimeSpan openFor, bool multipleChoice)
    {
        Answers = answers;
        OpenFor = openFor;
    ...
    /// </exception>
    public static PostPoll Of(IReadOnlyList<string> answers, TimeSpan openFor, bool multipleChoice = false)
    {
        ...
        return new PostPoll(answers, openFor, multipleChoice);
    }
