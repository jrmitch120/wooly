...
Four answers, structurally different, over the same fake timeline. Switch between them live with **F9 / F10**.
...
| `Variants/*.cs` | One file per shell. No shared layout — each is free to throw the whole thing out. |
