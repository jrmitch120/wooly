...
|---|---|---|---|---|
| **C·0** | Cycle, settling — **the anchor** (ADR-0014) | `tab` ×6 | **1** | Nothing, once tab counts steps and the highlight lands only after 180ms of stillness. Moving and asking on every keypress instead cost 6 with 5 discarded, which is what the other three were measured against. |
